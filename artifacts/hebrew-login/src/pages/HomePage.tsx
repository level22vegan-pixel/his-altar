        ...
        {!showCampuses ? (
          ...
          <div className="flex flex-col items-center gap-3 w-full fade-in">
            ...
            <div className="grid grid-cols-2 gap-3 w-full">
              {CAMPUSES.map((campus) => {
                const href = campus === "HALLMARK" ? "/campus/hallmark" : campus === "ARROWHEAD" ? "/campus/arrowhead" : campus === "RIVERSIDE" ? "/campus/riverside" : campus === "POMONA" ? "/campus/pomona" : campus === "LA" ? "/campus/la" : undefined;
                const btnStyle = {
